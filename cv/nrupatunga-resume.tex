...
\begin{itemize}
	\item
		...
		\begin{itemize}
				...
				\begin{itemize}
						\resitem{Trained Squeezenet model for deployment on Android phones. Accuracy: 69.5\%}
						\resitem{Trained Resnet-50, Resnet-101, Resnet-152 models with data augmentation and tweak to the model architecture to improve the recognition accuracy. Resnet-152 accuracy: 78.5\%}
						\resitem{Dataset: Food-101. Languages \& Tools used - Python, Caffe}
				\end{itemize}
				\vspace{1.2mm}
				\resitem[]{\faCircleO
					\hspace{1mm}\textbf{\emph{Deep Convolutional Network for Image Aesthetics}}\hspace{1mm}}
				\begin{itemize}
						\resitem{Trained 2-column VGG-16 model and GoogleNet model with data augmentation including data oversampling and multiple input crops. GoogleNet accuracy: 83.7\%}
						\resitem{Application developed to classify a given image into high and low quality}
						\resitem{Dataset: AVA. Languages \& Tools used - Python, PyQt, Caffe}
				\end{itemize}
				\vspace{1.2mm}
				% Project-2
				\resitem[]{\faCircleO
				...
				\begin{itemize}
						...
						\resitem{Dataset: SIFT flow. Languages \& Tools used - Python, Caffe}
				\end{itemize}
				\vspace{1.2mm}
				% Project-3
...
\begin{enumerate}
	...
	\item Implementation of Canny Edge Detector, Bilateral filter. Languages \& Tools used - \CC, OpenCV
