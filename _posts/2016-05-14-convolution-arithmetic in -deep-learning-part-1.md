---
layout: post
title: "Convolution Arithmetic in Deep Learning: Part-1"
tags: [Deep Learning]
---
...
Convolutional Neural Networks ([CNN](https://en.wikipedia.org/wiki/Convolutional_neural_network)) has
...
{% include image.html img="/assets/cnn.jpg" caption="Figure 1.1: CNN architecture" %}
...
* **_Affine Transformation_**: A vector is given as an input and is
	...
	* If you take [MNIST](http://yann.lecun.com/exdb/mnist/) digit recognition as an example, the
	 ...
	 the typical [fully connected neural network](http://ufldl.stanford.edu/tutorial/supervised/MultiLayerNeuralNetworks/) as shown in Figure 1.2
	...
	* In computer vision tasks, taking the advantage of implicit structure of the input data can be very handy
	{% include image.html img="/assets/mnist.png" caption="Figure 1.2: Multi-layer perceptron" %}
...
* **_Discrete Convolution_**: It is a linear transformation which respects the ordering of the input data that we discussed above
	...
	* It reuses the parameters i.e., same weights are applied to
	    ...
	    {% include image.html img="/assets/localconnectivity_sharedweights.png" caption="Figure 1.3: (a) Local connectivity (b) Shared weights" %}
...
* Figure 1.4 shows an example of a discrete convolution. The light blue
    ...
    **_kernel_** (_kernel values are at right bottom of each cell in shaded area_)
    {% include image.html img="/assets/convolution-2.1.png" caption="Figure 1.4: Computing the output values of a discrete convolution" %}
...
* For instance Figure 1.5 shows a \\(3\*3\\) kernel applied to
    ...
    strides
{% include image.html img="/assets/convolution-2.2.png" caption="Figure 1.5: Computing the output values of a discrete convolution for
...
{% include image.html img="/assets/convolution-2.3.png" caption="Figure 1.6: An alternative way of viewing strides. Instead of
...
{% include image.html img="/assets/no_padding_no_strides.png" caption="Figure 1.7: No Padding, Unit Strides" %}
...
{% include image.html img="/assets/arbitrary_padding_no_strides.PNG" caption="Figure 1.8: Zero Padding, Unit Strides" %}
...
{% include image.html img="/assets/same_padding_no_strides.PNG" caption="Figure 1.9: Half Padding, Unit Strides" %}
...
{% include image.html img="/assets/full_padding_no_strides.PNG" caption="Figure 1.10: Full Padding, Unit Strides" %}
...
{% include image.html img="/assets/no_padding_strides.PNG" caption="Figure 1.11: No zero padding, non-unit Strides" %}
...
{% include image.html img="/assets/arbitrary_padding_strides.PNG" caption="Figure 1.12 Arbitrary padding and Strides" %}
...
{% include image.html img="/assets/arbitrary_padding_strides-1.PNG" caption="Figure 1.13 Arbitrary padding and Strides" %}
